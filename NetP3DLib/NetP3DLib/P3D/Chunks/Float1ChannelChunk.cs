...
public class Float1ChannelChunk : ParamChunk
{
    ...
    public Float1ChannelChunk(EndianAwareBinaryReader br) : this(br.ReadUInt32(), br.ReadFourCC(), br.ReadUInt16Array(out var numFrames), br.ReadSingleArray(numFrames))
    {
    }
    ...
    protected override Chunk CloneSelf() => new Float1ChannelChunk(Version, Param, Frames, Values);
