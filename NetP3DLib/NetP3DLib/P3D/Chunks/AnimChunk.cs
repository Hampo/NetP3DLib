...
public class AnimChunk : NamedChunk
{
    ...
    public AnimChunk(EndianAwareBinaryReader br) : this(br.ReadP3DString(), br.ReadUInt32(), br.ReadUInt32())
    {
    }

    public AnimChunk(string name, uint version, bool hasAlpha) : this(name, version, hasAlpha ? 1u : 0u)
    {
    }
    ...
    protected override Chunk CloneSelf() => new AnimChunk(Name, Version, HasAlpha);
}
