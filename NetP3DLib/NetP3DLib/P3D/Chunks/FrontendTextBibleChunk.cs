...
[ChunkAttributes((uint)ChunkIdentifier.Frontend_Text_Bible)]
public class FrontendTextBibleChunk : NamedChunk
{
    ...
    public FrontendTextBibleChunk(BinaryReader br) : base((uint)ChunkIdentifier.Frontend_Text_Bible)
    {
    ...
    public FrontendTextBibleChunk(string name) : base((uint)ChunkIdentifier.Frontend_Text_Bible)
    {
        Name = name;
    }
