...
public class Vector3DOFChannelChunk : ParamChunk
{
    ...
    public Vector3DOFChannelChunk(EndianAwareBinaryReader br) : this(br.ReadUInt32(), br.ReadFourCC(), br.ReadUInt16Array(out var numFrames), br.ReadVector3Array(numFrames))
    {
    }
